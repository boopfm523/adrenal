  ...
  return data({
    exposure: {
      ...
      coverage_features: {
        ...
        uncategorized_symptom_count: referenceAvailable ? 1 : 0,
...
describe("Daily HealthCurve", () => {
  ...
  it("marks current local time and distinguishes only the later portion of today's chart", () => {
    ...
    expect(screen.getByRole("img")).toHaveAccessibleName(/region after the marker is later today and does not represent missing or zero data/i);
  ...
  it("shows close unscored symptoms as timed events without inventing severity", () => {
    renderWithTheme(<DailyHealthCurve data={data({ symptoms: [{
      ...
      tracking_category_revision: "symptom-tracking-category-v1",
