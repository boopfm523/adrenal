...
const EXPOSURE_REFERENCE_DETAILS: Readonly<Record<string, { label: string; use: string }>> = {
  ...
  "https://www.accessdata.fda.gov/drugsatfda_docs/label/2024/009866s121lbl.pdf": { label: "FDA Solu-Cortef label (2024)", use: "the intravenous sodium-succinate formulation and route-specific onset and elimination context" },
  "https://pubmed.ncbi.nlm.nih.gov/7120045/": { label: "Toothaker et al. (1982)", use: "dose-size-dependent intravenous hydrocortisone sodium succinate pharmacokinetics, which limits this model to the studied 50 mg amount" },
};
...
iv_total(t) = 1,347 × exp(-0.27 × elapsed_hours) nmol/L for each exact 50 mg IV push
