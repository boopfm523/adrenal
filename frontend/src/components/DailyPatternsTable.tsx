...
function exposureText(day: Day): React.JSX.Element {
  ...
  return <>Peak {formatMeasurement(day.exposure_peak_reu, "REU")}<span className="table-secondary">AUC {formatMeasurement(day.exposure_auc_reu_hours, "REU-hours")}</span></>;
}
