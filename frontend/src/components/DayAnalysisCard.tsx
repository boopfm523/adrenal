...
function analysisForDisplay(body: string): string {
  return body.replace(/\s*\[sources:[^\]]+\]/giu, "");
}
...
export function DayAnalysisCard({ day, timezone }: { day: string; timezone: string }): React.JSX.Element {
  ...
  return <details className="metric-definition healthcurve-day-analysis">
    ...
    <div className="category-card category-card--ai healthcurve-day-analysis-content">
