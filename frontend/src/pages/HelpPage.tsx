    ...
    <Page title="Help" description="Practical, current instructions for recording, reviewing, importing, correcting, and exporting HealthCurve.ai data.">
      ...
      <section id="plan-and-review" className="help-section anchor-target" aria-labelledby="plan-review-title">
        ...
        <div className="help-workflow-grid">
          ...
          <article className="help-workflow">
            <h3>Review HealthCurve, Timeline, and data quality</h3>
            <p>HealthCurve is the primary daily review: choose a past date to compare actual dose exposure with recorded context, then use longer-range analytics below it. Timeline remains the authoritative chronology ordered by experienced time. Every row shows category, source, confirmation, timezone, and correction provenance. Data quality is a bounded review queue—not proof that the record is complete.</p>
