...
function response(url: string, method = "GET"): Response {
  if (url.includes("/analytics/steroid-exposure")) {
    if (url.includes("model=hc-physiology-v2")) return jsonResponse({ date: "2026-08-01", timezone: "Europe/London", day_start: "2026-07-31T23:00:00Z", day_end: "2026-08-01T23:00:00Z", elapsed_hours: "24", series_kind: "modeled_plasma_free_cortisol_scenario", series_name: "Modeled plasma-free-cortisol scenario", series_unit: "nmol/L", safety_label: "Population-parameter modeled scenario—not a measurement or dosing guide.", definition: "Synthetic physiological scenario.", model: { id: "hc-physiology-v2", revision: "hc-physiology-v2.0.0", supported_medication: "hydrocortisone", supported_formulation: "conventional immediate-release tablet", supported_route: "oral", amount_unit: "mg", absorption_rate_per_hour: "1.4", oral_bioavailability: "0.96", clearance_liters_per_hour: "235.78", distribution_volume_liters: "474.38", cortisol_molecular_weight: "362.46", elimination_half_life_hours: "1.39", elimination_rate_per_hour: "0.497", peak_time_hours: "1.147", contribution_horizon_hours: 48, sample_interval_minutes: 5, references: [] }, source_revision_sha256: "a".repeat(64), dose_markers: [], samples: [{ occurred_at: "2026-07-31T23:00:00Z", local_time: "2026-08-01T00:00:00", utc_offset_minutes: 60, modeled_free_cortisol_nmol_l: "0", regular_modeled_free_cortisol_nmol_l: "0", stress_modeled_free_cortisol_nmol_l: "0" }, { occurred_at: "2026-08-01T09:00:00Z", local_time: "2026-08-01T10:00:00", utc_offset_minutes: 60, modeled_free_cortisol_nmol_l: "42", regular_modeled_free_cortisol_nmol_l: "42", stress_modeled_free_cortisol_nmol_l: "0" }], supported_dose_count: 0, excluded_dose_count: 0, context_band: { date: "2026-08-01", timezone: "Europe/London", day_start: "2026-07-31T23:00:00Z", day_end: "2026-08-01T23:00:00Z", elapsed_hours: "24", series_kind: "illustrative_circadian_context_band", series_name: "Illustrative circadian context band", series_unit: "nmol/L", default_visible: false, safety_label: "Illustrative context only.", band: { id: "hc-circadian-context-v1", revision: "hc-circadian-context-v1.0.0", interpolation: "pchip-no-overshoot", lower_multiplier: "0.8", upper_multiplier: "1.2", anchor_origin: "owner_supplied_synthetic_scenario", healthy_rhythm_evidence_scope: "shape_and_phase_context_only", personalized: false, body_context_used: false, demographic_reference_interval: false, references: [], anchors: [] }, recorded_stress_context: { episode_count: 0, missing_severity_count: 0, multiplier: "1", applied_to_band: false, applied_to_drug_model: false, reason: "No validated mapping." }, samples: [] } });
    return jsonResponse({ date: "2026-08-01", timezone: "Europe/London", day_start: "2026-07-31T23:00:00Z", day_end: "2026-08-01T23:00:00Z", elapsed_hours: "24", series_name: "Theoretical hydrocortisone exposure", series_unit: "REU", safety_label: "Theoretical hydrocortisone exposure—not a cortisol measurement or dosing guide.", definition: "Actual current doses produce a versioned relative exposure shape.", model: { version: "hc-exposure-v1", supported_medication: "hydrocortisone", supported_formulation: "conventional immediate-release tablet", supported_route: "oral", amount_unit: "mg", absorption_rate_per_hour: "2", elimination_half_life_hours: "1.7", elimination_rate_per_hour: "0.4077", peak_time_hours: "0.998", contribution_horizon_hours: 24, sample_interval_minutes: 5, references: [] }, dose_markers: [{ dose_event_id: "11111111-1111-4111-8111-111111111111", ...eventTime, medication_name: "Hydrocortisone", formulation: "conventional immediate-release tablet", amount: "10", unit: "mg", route: "oral", source_type: "manual", confirmation_state: "confirmed", supersedes_id: null, supported: true, exclusion_reason: null, carryover: false, modeled_peak_at: "2026-08-01T09:00:00Z" }], samples: [{ occurred_at: "2026-07-31T23:00:00Z", local_time: "2026-08-01T00:00:00", utc_offset_minutes: 60, theoretical_exposure_reu: "0" }, { occurred_at: "2026-08-01T09:00:00Z", local_time: "2026-08-01T10:00:00", utc_offset_minutes: 60, theoretical_exposure_reu: "10" }, { occurred_at: "2026-08-01T23:00:00Z", local_time: "2026-08-02T00:00:00", utc_offset_minutes: 60, theoretical_exposure_reu: "0.1" }], supported_dose_count: 1, excluded_dose_count: 0, context_band: { date: "2026-08-01", timezone: "Europe/London", day_start: "2026-07-31T23:00:00Z", day_end: "2026-08-01T23:00:00Z", elapsed_hours: "24", series_kind: "illustrative_circadian_context_band", series_name: "Illustrative circadian context band", series_unit: "nmol/L", default_visible: false, safety_label: "Illustrative context only.", band: { id: "hc-circadian-context-v1", revision: "hc-circadian-context-v1.0.0", interpolation: "pchip-no-overshoot", lower_multiplier: "0.8", upper_multiplier: "1.2", anchor_origin: "owner_supplied_synthetic_scenario", healthy_rhythm_evidence_scope: "shape_and_phase_context_only", personalized: false, body_context_used: false, demographic_reference_interval: false, references: [], anchors: [] }, recorded_stress_context: { episode_count: 0, missing_severity_count: 0, multiplier: "1", applied_to_band: false, applied_to_drug_model: false, reason: "No validated mapping." }, samples: [] } });
  }
  ...
  return jsonResponse({ date_from: "2026-08-01", date_to: "2026-08-02", timezone: "Europe/London", daily_doses: { definition: "Daily definition; missing is not zero.", timezone: "Europe/London", sample_count: 1, missing_count: 1, days_without_approved_plan: 1, values: [{ date: "2026-08-01", planned_total: "20", actual_total: "20", recorded_dose_count: 1, unit: "mg", incompatible_units: false }, { date: "2026-08-02", planned_total: null, actual_total: null, recorded_dose_count: 0, unit: null, incompatible_units: false }] }, timing: { definition: "On time means within 30 minutes.", timezone: "Europe/London", sample_count: 2, missing_count: 1, matched_count: 1, on_time: 1, early: 0, late: 0, unplanned: 0, total_absolute_deviation_minutes: "253", average_absolute_deviation_minutes: "21.0833333333333333333333333333", wake_sample_count: 2, wake_matched_count: 1, wake_missing_count: 1, wake_total_signed_minutes: "101", wake_average_signed_minutes: "33.6666666666666666666666666667", plan_periods: [{ regimen_version_id: "11111111-1111-4111-8111-111111111111", regimen_version_label: "Synthetic plan", effective_from: "2026-08-01T00:00:00", effective_to: null, sample_count: 2, matched_count: 1, missing_count: 1, on_time: 1, early: 0, late: 0, unplanned: 0, total_absolute_deviation_minutes: "253", average_absolute_deviation_minutes: "21.0833333333333333333333333333" }] }, episodes: { definition: "Resolved duration only.", timezone: "Europe/London", sample_count: 1, missing_count: 1, count: 1, total_duration_minutes: "0", average_duration_minutes: null }, symptoms: { definition: "Average of recorded severity only.", timezone: "Europe/London", sample_count: 0, missing_count: 0, count: 0, average_severity: null, frequency: {} } });
}
...
describe("Analytics page", () => {
  ...
  it("renders definitions, timezone, missingness, and the no-causation caution", async () => {
    ...
    const dailyPatternValues = screen.getByRole("region", { name: "Daily pattern values" });
    ...
    expect(screen.getAllByText("21.1 minutes")).toHaveLength(2);
    expect(screen.getByText("253 minutes")).toBeVisible();
    expect(screen.getByText("Wake-anchored slots")).toBeVisible();
    expect(screen.getByText("Average signed wake-to-dose timing")).toBeVisible();
    expect(screen.getByText("33.7 minutes")).toBeVisible();
  ...
  it("selects a shareable physiological model and preserves it across day navigation", async () => {
    const urls: string[] = [];
    vi.spyOn(globalThis, "fetch").mockImplementation((input, init) => { const url = requestUrl(input); urls.push(url); return Promise.resolve(response(url, init?.method)); });
    render(<HealthCurveProvider><QueryClientProvider client={new QueryClient({ defaultOptions: { queries: { retry: false } } })}><AuthContext.Provider value={auth}><MemoryRouter initialEntries={["/healthcurve?day=2026-08-01&timezone=Europe%2FLondon"]}><AnalyticsPage /><LocationProbe /></MemoryRouter></AuthContext.Provider></QueryClientProvider></HealthCurveProvider>);
    await screen.findByRole("heading", { name: "Your daily HealthCurve" });

    fireEvent.change(screen.getByLabelText("Exposure model"), { target: { value: "hc-physiology-v2" } });
    fireEvent.click(screen.getByRole("button", { name: "Review this day" }));
    await waitFor(() => { expect(urls.some((url) => url.includes("model=hc-physiology-v2"))).toBe(true); });
    expect(screen.getByTestId("location-search")).toHaveTextContent("model=hc-physiology-v2");
    expect(await screen.findByText(/Population-parameter modeled scenario/)).toBeVisible();
    fireEvent.click(screen.getByRole("button", { name: "Heart rate" }));
    fireEvent.click(screen.getByRole("button", { name: "Review previous day" }));
    expect(screen.getByTestId("location-search")).toHaveTextContent("model=hc-physiology-v2");
