...
| **P3 Dashboard, labs, reports** | In progress. Today, timeline, plan, episode, symptom/diary, analytics/chart, data-quality, and settings/privacy views are live. Immutable report snapshots plus local PDF/CSV/JSON APIs are live; the report-builder UI remains |
